...
void abrir_motor1 (){if(analogRead(control_motor1) <= control_motor1_max){digitalWrite(motor1_abre,HIGH);
digitalWrite(motor1_cierra,LOW);
}
else {digitalWrite(motor1_abre,LOW);
digitalWrite(motor1_cierra,LOW);
}
}
void cerrar_motor1 (){if(analogRead(control_motor1) >= control_motor1_min){digitalWrite(motor1_abre,LOW);
...
void abrir_motor2 (){if(analogRead(control_motor2) <= control_motor2_max){digitalWrite(motor2_abre,HIGH);
digitalWrite(motor2_cierra,LOW);
}
else {digitalWrite(motor2_abre,LOW);
digitalWrite(motor2_cierra,LOW);
}
}
void cerrar_motor2 (){if(analogRead(control_motor2) >= control_motor2_min){digitalWrite(motor2_abre,LOW);
...
void abrir_motor3 (){if(analogRead(control_motor3) <= control_motor3_max){digitalWrite(motor3_abre,HIGH);
digitalWrite(motor3_cierra,LOW);
}
else {digitalWrite(motor3_abre,LOW);
digitalWrite(motor3_cierra,LOW);
}
}
void cerrar_motor3 (){if(analogRead(control_motor3) >= control_motor3_min){digitalWrite(motor3_abre,LOW);
...
void parar_todo (){digitalWrite(motor1_cierra,LOW);
...
/***   Loop  ***/void loop(){if(analogRead(prox_dcha) >= umbral_abrir_dcho){abrir_motor1();
abrir_motor2();
abrir_motor3();
}
else if (analogRead(prox_izda) >= umbral_cerrar_izq){cerrar_motor1();
cerrar_motor2();
cerrar_motor3();
}
else if (analogRead(prox_dcha) >= umbral_inf_dcho){parar_todo();
muneca.write(180);
}
else if (analogRead(prox_izda) >= umbral_inf_izq){parar_todo();
muneca.write(0);
}
else {parar_todo();
}
